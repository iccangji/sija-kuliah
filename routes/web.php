...
Route::get('/',[SchedulesController::class, 'index'])->name('index')->middleware('auth');
Route::post('/cari-jadwal',[SchedulesController::class, 'search'])->name('search')->middleware('admin');
...
Route::get('/mata-kuliah',[CoursesController::class, 'index'])->name('course')->middleware('auth');
Route::post('/cari-mata-kuliah',[CoursesController::class, 'search'])->middleware('admin');
...
Route::get('/pengajar',[LecturersController::class, 'index'])->name('lecturer')->middleware('auth');
Route::get('/cari-pengajar',[LecturersController::class, 'index'])->middleware('admin');
Route::post('/cari-pengajar',[LecturersController::class, 'search'])->middleware('admin');
