    ...
    <div class="container mt-4">
      <form action="" method="post">
        ...
        <div class="form-floating mb-3 d-none">
          <input name="id" value="{{$lecturer['id']}}" type="text" class="form-control" id="floatingInput" placeholder="Mahasiswa" required>
          <label for="floatingInput">Kode Mata Kuliah</label>
        </div>
        <div class="form-floating mb-3">
          <input name="nidn" value="{{$lecturer['nidn']}}" type="text" class="form-control" id="floatingInput" placeholder="Mahasiswa" required>
          <label for="floatingInput">NIDN</label>
        </div>
        <div class="form-floating mb-3">
          <input name="nama" value="{{$lecturer['nama']}}" type="text" class="form-control" id="floatingInput" placeholder="Mahasiswa" required>
